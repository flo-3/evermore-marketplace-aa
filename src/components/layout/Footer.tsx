...
const Footer = () => {
    return (
        <div className="mx-auto py-16 xl:px-20 lg:px-12 sm:px-6 px-4 bg-gray-50">
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 md:gap-8 gap-4">
                <div className="flex flex-col flex-shrink-0">
                    <div>
                        <Image src={Logo} alt="Evermore logo" className="w-20" priority/>
                    </div>
                    <p className="text-sm leading-none text-gray-800 mt-4">Copyright © 2023 Evermore</p>
                    ...
                    <div className="flex items-center gap-x-4 mt-12">
                        <div className="opacity-50 w-8 h-8 flex-shrink-0 bg-gray-800 cursor-pointer hover:bg-gray-700 rounded-full flex items-center justify-center">
                            <Link href="https://twitter.com/evermore_nft" rel="noopener noreferrer" target="_blank">
                        ...
                        <div className="opacity-50 w-8 h-8 flex-shrink-0 bg-gray-800 cursor-pointer hover:bg-gray-700 rounded-full flex items-center justify-center">
                            <Link href="https://twitter.com/EvermoreLabs">
                        ...
                        <div className="opacity-50 w-8 h-8 flex-shrink-0 bg-gray-800 cursor-pointer hover:bg-gray-700 rounded-full flex items-center justify-center">
                            <Link href="https://www.linkedin.com/company/evermorelabs/about/">
                                <Image src={LinkedinLogo} alt="Linkedin logo" width="18" height="18"/>
                            </Link>
                        </div>
                    </div>
                </div>
